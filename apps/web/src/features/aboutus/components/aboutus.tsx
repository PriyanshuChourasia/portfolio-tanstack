  ...
  return (
    <motion.button
      ...
      className={`px-4 py-1.5 rounded-full text-sm font-medium border transition-colors ${
        active
          ? 'bg-primary-accent border-primary-accent text-white shadow-lg shadow-primary-accent/30'
          : 'border-slate-300 border-border text-slate-600 text-muted-foreground hover:border-primary-accent hover:text-primary-accent'
      }`}
    >
      {label}
    </motion.button>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex flex-col items-center justify-center gap-2 h-24 w-full rounded-xl border border-slate-200 border-border/70 bg-white/90 dark:bg-card/80 backdrop-blur-md shadow-lg hover:border-[var(--tech-accent)] hover:shadow-[0_0_28px_-6px_var(--tech-accent)] transition-colors overflow-hidden"
      >
        ...
        <span className="text-xs font-semibold text-slate-600 text-muted-foreground relative z-10 text-center px-1 leading-tight group-hover:text-slate-900 dark:group-hover:text-white transition-colors">
          {tech.label}
        </span>
      </motion.div>
    </div>
...
export default function AboutSection() {
  ...
  return (
    <section
      id="tech-stack"
      className="relative min-h-screen w-full overflow-hidden bg-slate-50 dark:bg-background py-24 sm:py-32"
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-slate-900 text-foreground drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)] drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
            Tech <span className="text-primary-accent">Stack</span>
          </h3>
          <p className="text-slate-500 text-muted-foreground text-sm italic mt-2">
