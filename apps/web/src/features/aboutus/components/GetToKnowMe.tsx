    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto drop-shadow-[0_1px_4px_rgba(0,0,0,0.3)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="flex items-start gap-4 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white/90 dark:bg-slate-800/30 hover:border-cyan-400/40 transition-colors backdrop-blur-sm"
          >
          ...
          <motion.div
            ...
            className="flex items-start gap-4 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white/90 dark:bg-slate-800/30 hover:border-blue-400/40 transition-colors backdrop-blur-sm"
          >
            <div className="shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-linear-to-r from-blue-500 to-cyan-500 text-white">
