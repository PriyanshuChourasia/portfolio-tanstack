...
export function CertificationEditor() {
  ...
  const { certifications } = activePortfolio
      ...
      {certifications.length === 0 ? (
        ...
        <div className="space-y-2">
          {certifications.map((cert) => {
            const isExpanded = expandedId === cert.id || !cert.name
            return (
              <Card key={cert.id} className="overflow-hidden">
                <button
                  onClick={() =>
                    setExpandedId(isExpanded && cert.name ? null : cert.id)
                  }
                ...
                {isExpanded && (
                  <div className="px-3 pb-3 space-y-3 border-t border-slate-100 dark:border-slate-800/50 pt-3">
                    ...
                    <div className="space-y-1">
                      <Label className="text-[11px]">Credential ID</Label>
                      <Input
                    ...
                    <div className="space-y-1">
                      <Label className="text-[11px]">Credential URL</Label>
                      <Input
                        type="url"
