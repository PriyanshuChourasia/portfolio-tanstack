...
export const Route = createFileRoute('/poland/backend')({
  head: () => ({
    meta: [
      {
        title:
          'Priyanshu Chourasia — Backend Software Engineer Resume (Poland)',
      },
      {
        name: 'description',
        content:
          'Backend-focused resume for Priyanshu Chourasia, targeting Java & Spring Boot backend engineering roles in Poland.',
      },
    ],
  }),
  component: Home,
...
const skillLines: Array<{ label: string; value: string }> = [
  { label: 'Languages', value: 'Java, TypeScript, JavaScript (ES6+), PHP' },
  {
      ...
      <main className="ats-page ats-page-sans">
        ...
        <section className="ats-section">
          ...
          <p style={{ margin: 0 }}>
            ...
            Builds internal Model Context Protocol (MCP) tooling to speed up
